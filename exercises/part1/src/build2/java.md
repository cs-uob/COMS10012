...
Maven will first show a list of all archetypes known to humankind (3046 at the time of counting) but you can just press ENTER to use the default, 1864 ("quickstart"). Maven now asks you for the version to use, press ENTER again.
